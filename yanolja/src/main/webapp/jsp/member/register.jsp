...
<div class="register">
	<div class="inner">
			...
			<div class="register_individual">
				<form action="registerProc" method="post" id="f">
					<ul>
						...
						<li><button type="button" class="registerBtn" onclick="idCheck()">중복 확인</button></li>
						<li><label id="labelId"></label></li>
					</ul>
					<ul>
						<li>비밀번호(*)</li>
						<li><input type="password" name="userPw" id="pw" style="width:500px;" placeholder="비밀번호를 입력하세요(영문+숫자+특수문자 8~20자리)"></li>
					</ul>
					<ul>
						<li></li>
					...
					<ul>
						<li>생년월일</li>
						<li>
							<select id="select_year" onchange="select_year()" placeholder="생년월일">
						...
						<li>
							<select id="select_month" onchange="select_month()">
								<option value="">-선택-</option>
						...
						<li>
							<select id="select_day" onchange="select_day()">
								<option value="">-선택-</option>
		...
		<button type="button" class="Btn" onclick="allCheck()">회원 가입</button>
