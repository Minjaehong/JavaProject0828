		...
		<div class="sideMenuBar_inner">
			...
			<div class="reservationManager_content">
				...
				<c:choose>
					...
					<c:otherwise>
						<div class="manager_reservationTable" align="center">
							<table border=1 class="manager_table">
								...
								<tbody align="center">
									...
									<tr>
										<td>
											<input type="radio" name="reservatinRadio" id="radioReservation" onclick="reservationCheck()" value=${rental.hostName } >
										</td>
